        ...
        >
            <div className="max-w-7xl mx-auto flex items-center justify-between">
                ...
                >
                    ...
                    <span className="text-lg ml-1"> Full-Stack Web Developer </span>
                </motion.div>
                ...
                <div className='md:hidden flex items-center space-x-4'>
                    <motion.button
                        ...
                        whileTap={{ scale: 0.95 }}
                        onClick={() => toggleDarkMode(isDarkMode ? "light" : "dark")}
                        className={`p-2 rounded-full transition-colors ${isDarkMode ? "text-gray-400 hover:text-white hover:bg-gray-800" : "text-gray-00 hover:text-gray-900 hover:bg-gray-200"
                            }
                        `}
                    >
                        {isDarkMode ? <Sun size={18} /> : <Moon size={18} />}
                    ...
                    <motion.button
                        ...
                        `}
                    >
                        {isMenuOpen ? <X zise={20} /> : <Menu size={20} />}
                    </motion.button>
                </div>
            </div>
