  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Project - Content */}
        <div className='p-6'>
          <h3 className='text-xl font-medium mb-3 group-hover:text-blue-300 transition-colors'>
            {project.title}
          </h3>

          <p className={`text-sm leading-relaxed mb-4 text-justify line-clamp-4 ${isDarkMode ? "text-gray-400" : "text-gray-600"
            }`}>
            {project.description}
          </p>
