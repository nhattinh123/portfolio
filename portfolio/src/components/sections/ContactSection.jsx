        ...
        >
            ...
            <div className='max-w-6xl mx-auto relative z-10'>
                ...
                >
                    ...
                    >
                        Hãy
                        <span className='text-blue-500 font-medium'> liên hệ </span>
                        với tôi
                    </motion.h2>
                    ...
                    >
                        Bạn đã sẵn sàng bắt đầu dự án tiếp theo chưa? Cùng tôi trao đổi để biến ý tưởng của bạn thành một sản phẩm thực tế, hiệu quả và ấn tượng.
                    </motion.p>
                </motion.div>
                ...
                <div className='grid lg:grid-cols-2 gap-16 items-start'>
                    ...
                    >
                        ...
                        >
                            <h3 className='text-2xl font-medium mb-8'> Bạn cần hỗ trợ ? Tôi luôn sẵn sàng lắng nghe! </h3>
                    ...
                    >
                        ...
                        <motion.div variants={itemVariants}>
                            <h3 className='text-2xl font-medium mb-6'>Bạn có thể tìm tôi tại đây</h3>
                        ...
                        <motion.div variants={itemVariants}>
                            <h3 className='text-xl font-medium mb-6'>Kết Nối Với Tôi</h3>
                        ...
                        >
                            ...
                            <p className={`text-sm ${isDarkMode ? "text-gray-400" : "text-gray-600"
                                ...
                                Hiện tại tôi có thể làm việc tự do hoặc toàn thời gian.
                            </p>
                        </motion.div>
                    </motion.div>
                </div>
                ...
                >
                    ...
                    >
                        <h3 className='text-xl font-medium mb-4'>Bạn muốn trao đổi trực tiếp?</h3>
                        <p
                            className={`${isDarkMode ? "text-gray-400" : "text-gray-600"} mb-6`}
                        >
                            Một cuộc gọi nhanh có thể giúp bạn làm rõ ý tưởng và tiết kiệm nhiều thời gian. Hãy lên lịch để chúng ta cùng thảo luận về dự án của bạn.
                        </p>
                        <motion.button
